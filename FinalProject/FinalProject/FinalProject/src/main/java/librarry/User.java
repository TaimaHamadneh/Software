...
public class User {	
	...
	public boolean logout(String username) {
		...
		for (int i = 0; i < 7; i++)	
		{
			if (username.equalsIgnoreCase(BookLibrary.Users.get(i).getName())
					&& BookLibrary.Users.get(i).getLogin().equals(Boolean.FALSE)) 
			 {
					BookLibrary.Users.get(i).setLogin(false);
					return true;
				}			
		}
		return false;
